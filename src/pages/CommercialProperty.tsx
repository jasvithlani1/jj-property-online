...
const commercialFaqs = [
  {
    question: 'How do you identify high-growth suburbs for businesses and commercial investors?',
  ...
  {
    question: 'What is your fee structure for property businesses and commercial investors?',
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-[#011122] mb-6 leading-tight">
                {pageData?.intro?.heading || "Precise Acquisition Strategies for Commercial Property"}
              </h2>
              <div className="space-y-6 text-lg text-muted font-sans leading-relaxed">
                ...
                <p className="font-semibold text-[#011122]">
                  {pageData?.intro?.heading ? "What we offer:" : "JJ Property Partner gives businesses and commercial investors a clear strategic edge:"}
                </p>
            ...
            <div className="text-center mb-20">
              ...
              <h2 className="text-5xl md:text-7xl font-serif text-[#011122] mb-8 leading-[1.1]">
                {pageData?.readiness?.heading?.includes('Right') ? (
                  <>Is Commercial Property Investment <br /> <span className="text-gold italic">Right for You?</span></>
