...
import { Home as HomeIcon, TrendingUp, ArrowRight, Plus, Star, Building2 } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div ref={containerRef} className="relative w-full bg-white selection:bg-gold/20">
            ...
            <div className="flex gap-3 mt-8 sm:mt-12">
              {heroSlides.map((_, idx) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all duration-500 ${currentSlide === idx ? 'w-8 bg-gold' : 'bg-white/30 hover:bg-white/50'
                    }`}
        ...
        {/* ── About Alex Preview ───────────────────────────────────────────── */}
        <section id="about" className="relative z-10 pt-4 pb-[1px] px-8 bg-gradient-to-b from-white to-neutral-50">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-sans font-black text-black leading-[1.05] mb-2">
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className={`leading-relaxed font-sans text-lg mb-3 flex-1 text-left md:text-center ${index % 2 === 0 ? 'text-white/70' : 'text-muted'}`}>
                          {service.description}
                        </p>
        ...
        {/* ── Process Section ──────────────────────────────────────────────── */}
        <section className="py-[1px] px-8 bg-white text-[#011122] overflow-hidden">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-3 relative z-10">
                {(homeData?.processSection?.steps || [
                  ...
                  >
                    {/* Circle Marker */}
                    <div className="w-16 h-16 rounded-full bg-gold flex items-center justify-center text-[#011122] text-2xl font-sans font-black mb-2 shadow-[0_8px_30px_rgb(200,169,106,0.3)] group-hover:scale-110 transition-transform duration-500 relative">
                      {item.num || (i + 1)}
                      <div className="absolute inset-0 rounded-full bg-gold animate-ping opacity-20 pointer-events-none group-hover:block hidden" />
                    </div>

                    <h3 className="text-lg font-sans font-black text-[#011122] mb-2 leading-tight font-medium">
                      {item.title}
                    </h3>
        ...
        <section id="case-studies" className="relative py-[1px] bg-gradient-to-b from-gold/5 to-gold/10 px-8 overflow-hidden">
        ...
        {/* ── Google Reviews ───────────────────────────────────────────────── */}
        <section id="reviews" className="relative py-[1px] bg-white overflow-hidden flex flex-col items-center">
          <div className="mb-2 text-center">
            ...
            <h2 className="text-2xl md:text-4xl font-sans font-black text-black mb-2">Google Verified Results</h2>
            <p className="text-muted font-sans text-sm tracking-widest uppercase">Trusted by Australia's premium buyers</p>
          </div>

          <div
            ref={carouselRef}
            className="w-full flex gap-6 overflow-x-auto no-scrollbar px-8 pb-4 cursor-grab active:cursor-grabbing select-none"
          ...
          >
            {[...reviews, ...reviews, ...reviews, ...reviews].map((review, i) => (
              <div key={`r-${i}`} className="w-80 md:w-96 p-5 rounded-3xl bg-neutral-50 border border-black/5 hover:border-black/10 transition-colors shrink-0 flex flex-col min-h-[280px] md:min-h-[300px]">
                <div className="flex items-center gap-1 mb-2">
                  {[...Array(review.rating)].map((_, j) => <Star key={j} className="w-4 h-4 fill-amber-400 text-amber-400" />)}
                </div>
                <p className="text-black font-sans font-black text-base leading-snug mb-3">
                  "{review.text}"
                </p>
        ...
        <section className="relative py-[1px] bg-gradient-to-b from-white to-neutral-50 px-8">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-2 lg:gap-8">
            <div className="lg:col-span-4 flex flex-col items-center text-center lg:items-start lg:text-left mb-2">
              ...
              <p className="text-muted text-lg font-sans text-left lg:text-left">Everything you need to know about the JJ Property Partner acquisition process.</p>
            </div>
        ...
        {/* ── Calendly Booking ────────────────────────────────────────────────── */}
        <section ref={calendlySectionRef} className="relative py-[1px] bg-neutral-50 px-8 overflow-hidden">
          <div className="max-w-4xl mx-auto text-center mb-2">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-sans font-black text-black leading-[1.0] mb-2">
