        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted font-sans leading-relaxed">
              <p>
                As Principal Advisor, Alex integrates <span className="text-black font-semibold">20+ years of enterprise IT systems architecture</span> with elite property negotiation. He understands that in a market driven by emotion, data is the ultimate equalizer.
              </p>
              <p>
                This isn't about traditional real estate sales. It's about data-driven acquisition. By dissecting market trends, leveraging silent off-market networks, and conducting clinical due diligence, Alex secures assets that outperform the market.
              </p>
              <p>
                From Parramatta corridors to Northern Beaches sanctuaries, Alex represents a strictly limited roster of premium buyers, ensuring focus, precision, and an uncompromised level of service.
              </p>
            </div>
          ...
          {[ 
            {
              ...
              text: "Emotions cost money. We use 20+ years of analytical expertise to dissect actual market value, ensuring you never over-capitalize.",
              icon: <Target className="w-8 h-8 text-sky-400" />
            },
            {
              title: "Off-Market Access",
              text: "The best assets never hit public portals. We unlock a hidden tier of luxury real estate through deeply guarded industry networks.",
              icon: <Search className="w-8 h-8 text-sky-400" />
            },
            {
              title: "Executive Representation",
              text: "Fierce advocacy at the negotiation table. We shield your identity and deploy clinical tactics to secure the winning outcome.",
