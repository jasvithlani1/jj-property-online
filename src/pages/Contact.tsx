...
export default function Contact() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-sky-50 selection:bg-black/10 pt-20 pb-12 md:pb-20">
      {/* Hero Section */}
      <section className="relative px-8 pt-16 pb-12 md:pt-24 md:pb-16 overflow-hidden text-center z-10">
        <motion.div
      ...
      <section className="relative px-8 pb-12 md:pb-20 z-10">
