...
export default function PropertyInvestors() {
 ...
 <div className="max-w-7xl mx-auto relative z-10 text-center">
            <Breadcrumb
              items={[{ name: 'Services', url: '/services' }, { name: 'Property Investors' }]}
              variant="dark"
              className="mb-6"
            />
 <motion.div
 ...
 <h3 className="text-3xl sm:text-4xl font-sans font-black text-white mb-4 relative z-10">{pageData?.readiness?.cta?.title || "Investor Strategy Session"}</h3>
