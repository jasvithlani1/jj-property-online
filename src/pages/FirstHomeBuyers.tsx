...
export default function FirstHomeBuyers() {
 ...
 { stepNumber: '05', title: 'Step 5 - Negotiation & Securing the Deal', body: 'We represent you at auction or in private treaty negotiations, using market data and discipline to secure the property on the best possible terms.', image: '/images/acquisitions/user_img_4.png' },
