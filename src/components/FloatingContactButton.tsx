  ...
  return (
    <>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-6 left-6 md:bottom-8 md:left-8 z-[5000] w-14 h-14 flex items-center justify-center rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.4)] text-gold bg-[#011122] border border-gold/50 group"
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[5000] w-14 h-14 flex items-center justify-center rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.4)] text-[#25D366] bg-[#011122] border border-[#25D366]/50 group"
        style={{ transform: 'translateZ(0)', WebkitTransform: 'translateZ(0)' }}
