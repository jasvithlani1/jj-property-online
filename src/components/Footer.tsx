      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10 pt-8 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left lg:col-span-1">
            <h4 className="text-xl font-semibold text-white mb-6 font-sans">Navigation</h4>            <ul className="space-y-4 font-sans text-sky-200/80 text-sm">
          ...
          {/* Services */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left lg:col-span-1">
            <h4 className="text-xl font-semibold text-white mb-6 font-sans">Services</h4>            <ul className="space-y-4 font-sans text-sky-200/80 text-sm">
          ...
          {/* Contact Info */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left lg:col-span-1">
            <h4 className="text-xl font-semibold text-white mb-6 font-sans">Connect</h4>            <ul className="space-y-6 font-sans text-sky-200/80">
