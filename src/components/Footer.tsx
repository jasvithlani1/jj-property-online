...
export default function Footer() {
  return (
    <footer className="relative bg-[#021f3a] text-white pt-20">
      {/* Skyline SVG Top Border */}
      <div className="absolute top-0 inset-x-0 -translate-y-full w-full overflow-hidden leading-none">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-24 lg:h-32 text-[#021f3a]" fill="currentColor">
