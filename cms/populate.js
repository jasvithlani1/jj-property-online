...
const data = {
  ...
  "hero": {
    "badge": "Our Expertise",
    "heading": "Precision property acquisition.",
    "subheading": "From first home buyers to seasoned investors, we provide end-to-end buyer's advocacy tailored to your wealth creation goals.",
    "stats": [
      { "_key": "s1", "value": "100%", "label": "Buyer Focused" },
      { "_key": "s2", "value": "20+", "label": "Years Experience" },
      { "_key": "s3", "value": "24/7", "label": "Client Support" }
    ]
  },
  "serviceList": [
    {
      "_key": "first-home-buyers",
  ...
  "finalCta": {
    ...
    "description": "Book a free 30-minute call. No pressure, no pitch — just a frank conversation about your property targets.",
    "primaryButtonText": "Book 30m Strategy Session"
  },
  "seo": {
    "metaTitle": "Our Services | JJ Property Partner",
    "metaDescription": "Discover our comprehensive buyer's agent services including First Home Buyer, Property Investor, and SMSF Property support."
  }
};
